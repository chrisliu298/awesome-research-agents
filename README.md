...
- [Taxonomy](#taxonomy)
  - [By Approach](#by-approach)
  - [By Research Stage](#by-research-stage)
- [Coding-Agent CLIs](#coding-agent-clis)
- [Skill Libraries & Workflow Packs](#skill-libraries--workflow-packs)
- [Sleep-time and Autonomous Research Loops](#sleep-time-and-autonomous-research-loops)
- [Multi-Agent Paper Writers and End-to-End Research Systems](#multi-agent-paper-writers-and-end-to-end-research-systems)
- [AI Co-Scientist and Hypothesis Systems](#ai-co-scientist-and-hypothesis-systems)
- [Literature-Grounded Research Agents](#literature-grounded-research-agents)
- [MCP Servers and Lab Integrations for Research](#mcp-servers-and-lab-integrations-for-research)
- [Benchmarks and Research Arenas](#benchmarks-and-research-arenas)
- [Practitioner Reports and Methodology Essays](#practitioner-reports-and-methodology-essays)
- [Surveys, Position Papers, and Cross-Cutting References](#surveys-position-papers-and-cross-cutting-references)
...
4. **ARIS: Autonomous Research via Adversarial Multi-Agent Collaboration** — study the strongest Claude/Codex-facing sleep-time research loop and its claim-audit patterns.
...
| Family | Representative entries | Pattern |
|---|---|---|
| Skill libraries | AI-Research-SKILLs, academic-research-skills, claude-scholar, W&B Skills | Reusable `SKILL.md`-style procedures, scripts, references, and commands. |
| Multi-agent paper writers | PaperOrchestra, Agent Laboratory, data-to-paper, PaperBanana | Role decomposition across outline, plotting, literature, writing, and refinement. |
| Sleep-time / autonomous loops | ARIS, The Agentic Researcher, karpathy/autoresearch, tinyKaggleClaw | Persistent state, queues, logs, retries, review loops, and long-running execution. |
| AI co-scientist systems | Towards an AI co-scientist, AlphaEvolve, AI Scientist v1/v2 | Hypothesis tournaments, experiment trees, evaluator-driven search, and automated review. |
| Literature-grounded agents | PaperQA2, OpenScholar, STORM, GPT Researcher | Retrieval, reranking, citation grounding, outline generation, and source tracking. |
| Research benchmarks & arenas | ResearchArena, PaperBench, MLAgentBench, MLE-bench, ScienceAgentBench | Agent evaluation through code, experiments, replications, rubrics, and generated papers. |
| MCP servers for research | W&B MCP, MLflow MCP, Zotero MCP, Jupyter MCP, paper-search-mcp | Agent-callable tools for papers, notebooks, experiment trackers, traces, and memory. |
| Coding-agent CLIs | Claude Code, Codex CLI, Aider, Gemini CLI, OpenHands, Goose | Terminal or IDE agents that inspect repos, edit files, run commands, and compose tools. |
...
| Experiment design | ARIS, The Agentic Researcher, Agent Laboratory, AI co-scientist, AAAR-1.0 |
...
| Analysis | Jupyter MCP Server, W&B Skills, MLflow MCP, data-to-paper, PaperOrchestra |
| Writing | PaperOrchestra, Agent Laboratory, AI Scientist, data-to-paper, GPT Researcher |
| Peer review | ResearchArena, Stanford Agentic Reviewer, AgentReview, The AI Scientist automated reviewer, LLM-REVal |
| Rebuttal | Paper2Rebuttal, ARIS, claude-code-my-workflow, ICML 2026 Peer Review FAQ |
| Project memory | Claude Code, Codex, Letta Code, Obsidian Memory, Zotero MCP, PARNESS, AgentRxiv |
...
- **[Microsoft AutoGen](https://microsoft.github.io/autogen/stable//index.html)** — multi-agent framework
  - *(2023, [adjacent])* Framework for single- and multi-agent applications with AgentChat, event-driven workflows, MCP workbenches, Docker code execution, and tool orchestration. Useful for custom research-agent prototypes, with the maintenance-mode caveat noted in the source synthesis.
...
- **Safe autonomous execution:** Sleep-time agents need sandboxing, permissioning, GPU budgets, scheduler policies, stop conditions, failed-run triage, and protection against evaluation-script tampering. Long-running compute control is still ad hoc.
